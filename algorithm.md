...
+ **длина внешнего пути** - сумма уровней внешних узлов.
    ...
    Если *длину пути* разделить на *количество узлов*, то можно узнать *средний уровень* узла в дереве. Меньшие значения означают, дерево позволяет быстрее добираться из своего корня до произвольного узла.
