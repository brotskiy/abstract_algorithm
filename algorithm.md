...
Некоторый один узел дерева назначают **корнем**. Говорят, что узел $y$ располагается **под** узлом $x$, если $x$ находится на пути от $y$ к корню. Каждый узел, за исключением корня, имеет ровно один расположенный непосредственно над ним узел, называемый **родительским**. Узлы, расположенные непосредственно ниже, называют **дочерними**. Узлы, имеющие общего родителя, называют **родственными**. Узлы, у которых нет дочерних, называются **листьями**, *внешними* или *терминальными* узлами.
